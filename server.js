...
setInterval(() => {
  http.get(`http://1dash1.glitch.me/`);
}, 280000);
...
client.on('message', msg => {  
    if (msg.content === 'لميا') {  
      msg.reply('**تقصد لميا الاسطورة بس تشوف تعليقك رح تجاوبك**');  
    }
  });
...
client.on('message', msg => {  
    if (msg.content === 'قمر') {  
      msg.reply('** تقصد قمر الوردة حبيبة لميا  **');  
    }
  });

client.on('message', msg => {  
    if (msg.content === 'ابو كدود') {  
      msg.reply('**تقصد ابوكدود الاسطورة ملك البوبجي**');  
    }
  });

client.on('message', msg => {  
    if (msg.content === 'حسن') {  
      msg.reply('**تقصد الاسطورة حسن اخو لميا **');  
    }
  });

client.on('message', msg => {  
    if (msg.content === 'زوزو') {  
      msg.reply('**تقصد زوزو الوردة الحلوة حبيبة لميا**');  
    }
  });

client.on('message', msg => {  
    if (msg.content === 'فوفه') {  
      msg.reply('**تقصد فوفة الوردة والحلوة حبيبة لميا**');  
    }
  });

  client.on('message', msg => {  
    if (msg.content === 'احبك') {  
      msg.reply('**حبك برص يا 😡**');  
    }
  });

client.on('message', msg => {  
    if (msg.content === 'حمزه') {  
      msg.reply('**قصدك اسطوره السيرفر:smirk::smirk:هيهي بوي**');  
    }
  });

client.on('message', msg => {  
    if (msg.content === 'طالب') {  
      msg.reply('**قصدك طالب اخو لميا :smirk::smirk:هيهي بوي**');  
    }
  });

client.on('message', msg => {  
    if (msg.content === 'امير') {  
      msg.reply('**قصدك امير اخو لميا :smirk::smirk:هيهي بوي**');  
    }
  });
...
client.on('message', msg => {  
    if (msg.content === 'زورو') {  
      msg.reply('**قصدك اسطوره البوبجي:smirk::smirk:هيهي بوي**');  
    }
  });

client.on('message', msg => {  
    if (msg.content === 'ابو رهف') {  
      msg.reply('**قصدك اسطوره البوبجي:smirk::smirk:هيهي بوي**');  
    }
  });
...
client.on('message', msg => {  
    if (msg.content === 'صباح الخير') {  
      msg.reply('**صباح الخير يبعد عيني  ❤❤**');  
    }
  });

client.on('message', msg => {  
    if (msg.content === 'مساء الخير') {  
      msg.reply('**مساء الخيرات هلا بالقلب والروح    ❤❤❤**');  
    }
  });
...
client.on('message', msg => {  
    if (msg.content === 'السلام عليكم') {  
      msg.reply('**وعليكم السلام هلا والله :heart: **');  
    }
  });
*/
...
if(!message.channel.guild) return message.reply(' ');
  ...
  let submite = message.guild.channels.find(`name`, "🏫➕التــقديمـات➕🏫");
...
client.login('NzQyNDMwODU0ODIyODg3NTY3.XzGAnQ.WZVkx0YBmbgjV2eW_sqdUpOZ5UU');
